...
public class WebsiteOptions
{
    ...
    /// 
    /// </summary>
    public string BootstrapAdminLink { get; set; } = "https://task9.pro";

    /// <summary>
    /// 
    /// </summary>
    public string GiteeRepositoryUrl { get; set; } = "https://task9.pro";

    /// <summary>
    /// 
    /// </summary>
    public string VideoLibUrl { get; set; } = "https://task9.pro";

    /// <summary>
    /// 仓库源码地址
    /// </summary>
    public string SourceUrl { get; set; } = "https://task9.pro";
    ...
    /// Github 仓库地址
    /// </summary>
    public string GithubRepositoryUrl { get; set; } = "https://task9.pro";

    /// <summary>
    /// 
    /// </summary>
    public string WikiUrl { get; set; } = "https://task9.pro";

    /// <summary>
    /// 获得 QQ 1 群链接地址
    /// </summary>
    public string? QQGroup1Link { get; set; } = "https://task9.pro";

    /// <summary>
    /// 获得 QQ 2 群链接地址
    /// </summary>
    public string? QQGroup2Link { get; set; } = "https://task9.pro";
